...
Make player crystal damage taken continuous between battles in the same age, the hp resets between ages - Then change the "heal" encounter to heal the player base hp.
Make sure all Path types (see 4.1 at @GAME_META for details on each path type, including icons and descriptions)

Apply section 3 in @GAME_META to the campaign mode.